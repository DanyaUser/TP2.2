...
std::cout << "The file name is too short." << std::endl;
return false;
}
...
|| (file[4] == '\0'))) || (((file[0] == 'l') || (file[0] == 'L')) &&
((file[1] == 'p')
|| (file[1] == 'P')) && ((file[2] == 't') || (file[2] == 'T'))
&& ((file[3] == '1')
|| (file[3] == '2') || (file[3] == '3') || (file[3] ==
'4') || (file[3] == '5')
|| (file[3] == '6') || (file[3] == '7') || (file[3] ==
'8') || (file[3] == '9'))
&& ((file[4] == '.') || (file[4] == '\0'))))
{
std::cin.ignore(INT_MAX, '\n');
std::cout << "This filename is used by Windows." << std::endl;
return false;
}
int i = file.size();
if ((file[i] == '\0') && (file[i - 1] == 't') && (file[i - 2] == 'x') && (file[i - 3] == 't') && (file[i - 4] == '.') || (file[i] == '\0') && (file[i - 1] == 't') && (file[i - 2] == 'a') && (file[i - 3] == 'd') && (file[i - 4] == '.'))
return true;
else
{
if (file[i - 1] != '0')
std::cout << "The file must be in .txt or .dat format" << std::endl;
return false;
}
}
...
std::cout << "Re-enter the name (with extension): ";
std::cin >> filename;
isCorrect = checkFilename(filename);
if (isCorrect)
file.open(filename);
